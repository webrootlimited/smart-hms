...
import { Mic, MicOff, Video, PhoneOff, Shield, Paperclip, Smile, Send, MessageSquare, X } from "lucide-react"
...
export default function VideoCallScreen() {
    ...
    return (
        <div className="w-full h-screen flex flex-col">
            {/* Top Header */}
            <div className="w-full bg-white border-b border-gray-200 px-2 h-[3rem] translate-y-1/5 md:px-4">
                <div className="max-w-7xl mx-auto flex items-center justify-between text-xs md:text-sm">
                    ...
                    {/* Center: Encrypted Badge */}
                    <div className="hidden lg:block absolute left-1/2 -translate-x-1/2">
                        <div className="flex items-center gap-1 px-2 py-1 bg-green-50 border border-green-200 rounded-full text-[9px] md:text-xs whitespace-nowrap">
                            <Shield className="w-3 h-3 md:w-4 md:h-4 text-green-600 shrink-0" />
                            <span className="font-medium text-green-700">Encrypted Connection</span>
                        </div>
                    </div>
                    {/* Right: Doctor Info with online avatar */}
                    <div className="flex items-center gap-2 md:gap-3 text-[9px] md:text-xs min-w-0">
                        <div className="text-right hidden sm:block min-w-0">
                            <p className="font-semibold text-gray-900 truncate">Dr. Sarah Mitchell</p>
                            <p className="text-[8px] md:text-[9px] text-gray-500 truncate">Cardiologist</p>
                        </div>
                        <div className="relative shrink-0">
                            <div className="w-8 h-8 md:w-9 md:h-9 rounded-full overflow-hidden border-2 border-gray-300">
                                <Image
                ...
                <div className="w-full max-w-7xl flex gap-4 h-full lg:h-auto">
                    ...
                    >
                        ...
                        <div className="absolute top-2 right-2 z-30">
                            <div className="w-24 h-24 md:w-32 md:h-32 rounded-lg overflow-hidden border-2 border-white shadow-lg">
                                <Image
                        ...
                        <div className="absolute top-2 left-2 right-2 flex flex-wrap gap-2 text-[9px] md:text-xs z-20">
                            <div className="flex items-center gap-1 bg-white/70 backdrop-blur-sm px-2 py-1 rounded-full whitespace-nowrap">
                                ...
                                <span className="hidden sm:inline">Dr. Mitchell is speaking...</span>
                        ...
                        <div className="w-full md:w-80 lg:w-96 bg-white rounded-2xl shadow-2xl flex flex-col z-50 border border-gray-200 h-full lg:h-[80vh]">
                            ...
                            <div className="px-3 md:px-4 py-2 md:py-3 border-b border-gray-200 flex items-center justify-between shrink-0">
                                <div className="flex items-center gap-2 md:gap-3 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                        <p className="font-semibold text-gray-900 text-sm md:text-base truncate">Dr. Sarah Mitchell</p>
