        ...
        <header className="bg-white pl-16 lg:pl-7 border-b border-[#E2E8F0] px-6 py-2 sticky top-0 z-10">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 ml-4">
                    ...
                    {/* 👉 Notification + Settings (show only above xl) */}
                    <div className="hidden xl:flex items-center gap-4 pr-8 border-r-2 border-[#E2E8F0]">
                        <Bell className="w-10 h-10 text-gray-600 border border-[#E2E8F0] rounded-full p-2 cursor-pointer hover:text-gray-900" />
                        <Settings className="w-10 h-10 text-gray-600 border border-[#E2E8F0] rounded-full p-2 cursor-pointer hover:text-gray-900" />
                    </div>
                        ...
                        <div className="flex items-center gap-3 pl-4 ">
                            ...
                            <div className="flex items-center gap-1">
                                <div className="hidden xl:flex flex-col">
                                    ...
                                    <p className="text-xs text-gray-500">Patient ID: #8492</p>
                                </div>
