            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex-1 hidden xl:flex flex-col">
                    <h2 className="text-lg font-bold text-[#0F172A]">
                        Welcome back, Sarah! 👋 <span className="font-medium text-xs bg-blue-200 px-2 py-1 rounded-2xl">Front Desk Receptionist</span>
                    </h2>
                    <div className="flex gap-5 items-center">
                        <p className="text-sm text-[#0F172A] mt-0.5 flex items-center gap-1">
                            <MapPin className="w-4 h-4" />
                            City Medical Center - Main Reception
                        </p>
