...
import {
    Receipt, CreditCard, Undo2, BarChart3, FileText, Menu, X, LayoutDashboard,
...
const navLinks = [
    {
        ...
        href: "/billing-officer/dashboard",
    },
    {
        name: "Invoices",
        icon: Receipt,
        href: "/billing-officer/invoices",
    },
    {
        name: "Payments",
        icon: CreditCard,
        href: "/billing-officer/payments",
    },
    {
        name: "Insurance Claims",
        icon: FileText,
        href: "/billing-officer/insurance-claims",
    },
    {
        name: "Refunds and Disputes",
        icon: Undo2,
        href: "/billing-officer/refunds",
    },
    {
        name: "Reports",
        icon: BarChart3,
        href: "/billing-officer/reports",
    },
];
