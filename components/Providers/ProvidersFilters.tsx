...
import { DEPARTMENTS, SPECIALTIES, STATUSES, LOCATIONS } from "./mockData";
    ...
    <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
        ...
        <Select
          ...
          onValueChange={(v) => onChange({ ...filters, status: v === "all" ? "" : (v as ProviderStatus) })}
        >
          <SelectTrigger className="w-full rounded-xl">
        ...
        <Select
          ...
          onValueChange={(v) => onChange({ ...filters, location: v === "all" ? "" : v })}
        >
          <SelectTrigger className="w-full rounded-xl">
